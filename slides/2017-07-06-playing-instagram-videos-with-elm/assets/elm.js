...
var _w0rm$elm_slice_show$Main$conclusion = {
	ctor: '::',
	_0: _w0rm$elm_slice_show$Formatting$title('Conclusion'),
	_1: {
		ctor: '::',
		_0: _w0rm$elm_slice_show$Formatting$bullets(
			{
				ctor: '::',
				_0: _w0rm$elm_slice_show$Formatting$bullet('Elm is great'),
				_1: {
					ctor: '::',
					_0: _w0rm$elm_slice_show$Formatting$bullet('Elm is not enough'),
					_1: {
						ctor: '::',
						_0: _w0rm$elm_slice_show$Formatting$bullet('Learn useful things by doing useless projects'),
						_1: {ctor: '[]'}
					}
				}
			}),
...
var _w0rm$elm_slice_show$Main$settingUpTravisCI = {
	ctor: '::',
	_0: _w0rm$elm_slice_show$Formatting$title('Setting up Travis CI'),
	_1: {
		ctor: '::',
		_0: _w0rm$elm_slice_show$Formatting$bullets(
			{
				ctor: '::',
				_0: A2(_w0rm$elm_slice_show$Formatting$bulletLink, 'Script to download new videos', 'https://github.com/w0rm/elm-gigs/blob/master/download.sh'),
				_1: {
					ctor: '::',
					_0: A2(_w0rm$elm_slice_show$Formatting$bulletLink, 'Script to publish to GitHub pages', 'https://github.com/w0rm/elm-gigs/blob/master/gh-pages.sh'),
					_1: {
						ctor: '::',
						_0: A2(_w0rm$elm_slice_show$Formatting$bulletLink, 'Epic build time improvement', 'https://github.com/w0rm/elm-gigs/blob/master/.travis.yml#L13'),
						_1: {ctor: '[]'}
					}
				}
			}),
...
var _w0rm$elm_slice_show$Main$keepingLocationInSync = {
	ctor: '::',
	_0: _w0rm$elm_slice_show$Formatting$title('Keeping Location in Sync'),
	_1: {
		ctor: '::',
		_0: _w0rm$elm_slice_show$Formatting$bullets(
			{
				ctor: '::',
				_0: A2(_w0rm$elm_slice_show$Formatting$bulletLink, 'Storing the initial slug', 'https://github.com/w0rm/elm-gigs/blob/master/Model.elm#L9'),
				_1: {
					ctor: '::',
					_0: A2(_w0rm$elm_slice_show$Formatting$bulletLink, 'Playing the random video', 'https://github.com/w0rm/elm-gigs/blob/master/Main.elm#L123'),
					_1: {ctor: '[]'}
				}
			}),
		_1: {ctor: '[]'}
...
var _w0rm$elm_slice_show$Main$layingOutTheText = {
	ctor: '::',
	_0: _w0rm$elm_slice_show$Formatting$title('Laying Out the Text'),
	_1: {
		ctor: '::',
		_0: _w0rm$elm_slice_show$Formatting$bullets(
			{
				ctor: '::',
				_0: A2(_w0rm$elm_slice_show$Formatting$bulletLink, 'Rendering svg mask element', 'https://github.com/w0rm/elm-gigs/blob/master/View.elm#L93'),
				_1: {
					ctor: '::',
					_0: A2(_w0rm$elm_slice_show$Formatting$bulletLink, 'Measuring the text', 'https://github.com/w0rm/elm-gigs/blob/master/Clip.elm#L38'),
					_1: {
						ctor: '::',
						_0: A2(_w0rm$elm_slice_show$Formatting$bulletLink, 'Using ports', 'https://github.com/w0rm/elm-gigs/blob/master/index.html#L25'),
						_1: {ctor: '[]'}
					}
				}
			}),
...
var _w0rm$elm_slice_show$Main$playingTheVideo = {
	ctor: '::',
	_0: _w0rm$elm_slice_show$Formatting$title('Playing the Video'),
	_1: {
		ctor: '::',
		_0: _w0rm$elm_slice_show$Formatting$bullets(
			{
				ctor: '::',
				_0: A2(_w0rm$elm_slice_show$Formatting$bulletLink, 'Using the video element', 'https://github.com/w0rm/elm-gigs/blob/master/View.elm#L77'),
				_1: {
					ctor: '::',
					_0: _w0rm$elm_slice_show$Formatting$bullet('Playing the video twice'),
					_1: {
						ctor: '::',
						_0: _w0rm$elm_slice_show$Formatting$bullet('Errors in Safari and iOS'),
						_1: {ctor: '[]'}
					}
				}
			}),
...
var _w0rm$elm_slice_show$Main$gettingTheData = {
	ctor: '::',
	_0: _w0rm$elm_slice_show$Formatting$title('Getting the Data'),
	_1: {
		ctor: '::',
		_0: _w0rm$elm_slice_show$Formatting$bullets(
			{
				ctor: '::',
				_0: _w0rm$elm_slice_show$Formatting$bullet('Limitation of the Instagram API'),
				_1: {
					ctor: '::',
					_0: A2(_w0rm$elm_slice_show$Formatting$bulletLink, 'Writing decoders', 'https://github.com/w0rm/elm-gigs/blob/master/Video.elm#L10'),
					_1: {ctor: '[]'}
				}
			}),
		_1: {ctor: '[]'}
...
var _w0rm$elm_slice_show$Main$challenges = {
	ctor: '::',
	_0: _w0rm$elm_slice_show$Formatting$title('Challenges'),
	_1: {
		ctor: '::',
		_0: _w0rm$elm_slice_show$Formatting$bullets(
			{
				ctor: '::',
				_0: _w0rm$elm_slice_show$Formatting$bullet('Getting the data'),
				_1: {
					ctor: '::',
					_0: _w0rm$elm_slice_show$Formatting$bullet('Playing the video'),
					_1: {
						ctor: '::',
						_0: _w0rm$elm_slice_show$Formatting$bullet('Laying out the text'),
						_1: {
							ctor: '::',
							_0: _w0rm$elm_slice_show$Formatting$bullet('Keeping location in sync'),
							_1: {
								ctor: '::',
								_0: _w0rm$elm_slice_show$Formatting$bullet('Setting up Travis CI'),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _w0rm$elm_slice_show$Main$idea = {
	ctor: '::',
	_0: A2(
		_w0rm$elm_slice_show$Formatting$position,
		{ctor: '_Tuple2', _0: 150, _1: 120},
		{
			ctor: '::',
			_0: A2(
				_w0rm$elm_slice_show$Formatting$image,
				{ctor: '_Tuple2', _0: 400, _1: 400},
				'assets/unsoundscapes.gif'),
			_1: {
				ctor: '::',
				_0: _w0rm$elm_slice_show$Formatting$richtext('[unsoundscapes.com](http://unsoundscapes.com)'),
				_1: {ctor: '[]'}
			}
		}),
	_1: {
		...
		_0: A2(
			...
			{ctor: '_Tuple2', _0: 700, _1: 120},
			{
				...
				_1: {
					ctor: '::',
					_0: _w0rm$elm_slice_show$Formatting$richtext('100+ videos from concerts'),
					_1: {ctor: '[]'}
				}
			}),
		_1: {ctor: '[]'}
...
var _w0rm$elm_slice_show$Main$intro = {
	ctor: '::',
	_0: _w0rm$elm_slice_show$SliceShow_Content$item(
		A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Playing Instagram Videos with Elm'),
				_1: {ctor: '[]'}
			})),
	_1: {
		ctor: '::',
	...
	_w0rm$elm_slice_show$SliceShow$init(
		A2(
			...
			},
			{
				...
				_0: {
					ctor: '::',
					_0: _w0rm$elm_slice_show$Formatting$padded(_w0rm$elm_slice_show$Main$intro),
					_1: {ctor: '[]'}
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '::',
						_0: _w0rm$elm_slice_show$Formatting$shout('Idea'),
						_1: {ctor: '[]'}
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '::',
							_0: _w0rm$elm_slice_show$Formatting$padded(_w0rm$elm_slice_show$Main$idea),
							_1: {ctor: '[]'}
						},
						_1: {
							ctor: '::',
							_0: {
								...
								_1: {
									...
									_0: A2(
										_w0rm$elm_slice_show$Formatting$position,
										{ctor: '_Tuple2', _0: 450, _1: 500},
										{
											ctor: '::',
											_0: _w0rm$elm_slice_show$Formatting$richtext('[gigs.unsoundscapes.com](http://gigs.unsoundscapes.com#arcade-fire)'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
							...
							_1: {
								...
								_0: {
									ctor: '::',
									_0: _w0rm$elm_slice_show$Formatting$padded(_w0rm$elm_slice_show$Main$challenges),
									_1: {ctor: '[]'}
								},
								_1: {
									ctor: '::',
									_0: {
										ctor: '::',
										_0: _w0rm$elm_slice_show$Formatting$padded(_w0rm$elm_slice_show$Main$gettingTheData),
										_1: {ctor: '[]'}
									},
									_1: {
										ctor: '::',
										_0: {
											ctor: '::',
											_0: _w0rm$elm_slice_show$Formatting$padded(_w0rm$elm_slice_show$Main$playingTheVideo),
											_1: {ctor: '[]'}
										},
										_1: {
											ctor: '::',
											_0: {
												ctor: '::',
												_0: _w0rm$elm_slice_show$Formatting$padded(_w0rm$elm_slice_show$Main$layingOutTheText),
												_1: {ctor: '[]'}
											},
											_1: {
												ctor: '::',
												_0: {
													ctor: '::',
													_0: _w0rm$elm_slice_show$Formatting$padded(_w0rm$elm_slice_show$Main$keepingLocationInSync),
													_1: {ctor: '[]'}
												},
												_1: {
													ctor: '::',
													_0: {
														ctor: '::',
														_0: _w0rm$elm_slice_show$Formatting$padded(_w0rm$elm_slice_show$Main$settingUpTravisCI),
														_1: {ctor: '[]'}
													},
													_1: {
														ctor: '::',
