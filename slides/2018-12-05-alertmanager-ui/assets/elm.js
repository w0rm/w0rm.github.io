...
var author$project$Main$elm = _List_fromArray(
	[
		A3(
		...
		author$project$Formatting$bullets(
			_List_fromArray(
				[
					author$project$Formatting$bullet('Simple setup'),
					author$project$Formatting$bullet('Narrow developer focus'),
					author$project$Formatting$bullet('Confidence in making changes')
				])))
	]);
...
var author$project$Main$intro = _List_fromArray(
	[
		...
		100,
		20,
		author$project$Formatting$title('Improving UX and DX of the Alermanager UI')),
		A3(
		author$project$Formatting$position,
		100,
		625,
...
var author$project$Main$new = _List_fromArray(
	[
		author$project$Formatting$col(
		_List_fromArray(
			[
				A3(author$project$Formatting$image, (2558 / 2) | 0, (1342 / 2) | 0, 'assets/new.png'),
				w0rm$elm_slice_show$SliceShow$Content$hide(
				A3(
					author$project$Formatting$position,
					500,
					300,
					author$project$Formatting$title('Demozeit!')))
			]))
	]);
var author$project$Main$newItems = _List_fromArray(
	[
		A3(
		author$project$Formatting$position,
		100,
		50,
		author$project$Formatting$title('New Alertmanager')),
		A3(
		author$project$Formatting$position,
		100,
		150,
		author$project$Formatting$bullets(
			_List_fromArray(
				[
					author$project$Formatting$bullet('More features'),
					author$project$Formatting$bullet('Improved user experience'),
					author$project$Formatting$bullet('More contributors')
				])))
	]);
var author$project$Main$old = _List_fromArray(
	[
		author$project$Formatting$col(
		_List_fromArray(
			[
				author$project$Formatting$spacer(10),
				A3(author$project$Formatting$image, (2426 / 2) | 0, (1340 / 2) | 0, 'assets/old.png')
			]))
	]);
var author$project$Main$oldItems = _List_fromArray(
	[
		A3(
		author$project$Formatting$position,
		100,
		50,
		author$project$Formatting$title('Old Alertmanager')),
		A3(
		author$project$Formatting$position,
		100,
		150,
		author$project$Formatting$bullets(
			_List_fromArray(
				[
					author$project$Formatting$bullet('Missing features (e.g. filtering, grouping)'),
					author$project$Formatting$bullet('Poor user experience'),
					author$project$Formatting$bullet('Little amount of contributions')
				])))
	]);
...
var author$project$Main$prs = _List_fromArray(
	[
		A3(
		author$project$Formatting$position,
		100,
		50,
		author$project$Formatting$title('Pull requests')),
		A3(
		author$project$Formatting$position,
		100,
		150,
		author$project$Formatting$bullets(
			_List_fromArray(
				[
					A2(author$project$Formatting$bulletLink, '#789 Rewrite UI in Elm', 'https://github.com/prometheus/alertmanager/pull/789'),
					A2(author$project$Formatting$bulletLink, '#827 Improved Validation', 'https://github.com/prometheus/alertmanager/pull/827'),
					A2(author$project$Formatting$bulletLink, '#1539 Upgrade Alertmanager UI to Elm 0.19', 'https://github.com/prometheus/alertmanager/pull/1539'),
					A2(author$project$Formatting$bulletLink, '#1613 Move /status & /silences to API v2', 'https://github.com/prometheus/alertmanager/pull/1613')
				])))
	]);
var author$project$Main$schema = _List_fromArray(
	[
		author$project$Formatting$col(
		_List_fromArray(
			[
				author$project$Formatting$spacer(10),
				A3(author$project$Formatting$image, (2124 / 2) | 0, (1348 / 2) | 0, 'assets/schema.png')
			]))
	]);
...
var author$project$Main$main = w0rm$elm_slice_show$SliceShow$show(
	w0rm$elm_slice_show$SliceShow$init(
		A2(
			...
			_List_fromArray(
				[author$project$Main$intro, author$project$Main$about, author$project$Main$schema, author$project$Main$old, author$project$Main$oldItems, author$project$Main$new, author$project$Main$newItems, author$project$Main$prs, author$project$Main$elm]))));
