				...
				[
					...
					_List_fromArray(
						[
							...
							'#f8310e',
							author$project$Formatting$text('仕事'))
						])),
					...
					author$project$Formatting$col(
						_List_fromArray(
							[
								...
								author$project$Formatting$color,
								'#5a6378',
								author$project$Formatting$text('エルム')),
								A2(
								author$project$Formatting$color,
								'#5a6378',
								author$project$Formatting$text('ベルリン'))
							]))),
					w0rm$elm_slice_show$SliceShow$Content$hide(
					author$project$Formatting$col(
						_List_fromArray(
							[
								...
								author$project$Formatting$color,
								'#e6522c',
								author$project$Formatting$text('Prometheusの')),
								A2(
								author$project$Formatting$color,
								'#e6522c',
...
var author$project$Main$debug = _List_fromArray(
	[
		...
		100,
		50,
		author$project$Formatting$title('デバッグ')),
		A3(
		author$project$Formatting$position,
		100,
		150,
		author$project$Formatting$bullets(
			_List_fromArray(
				[
					...
					author$project$Formatting$bullet('テストを書く'),
					author$project$Formatting$bullet('ビジュアルデバッグ')
				]))),
		w0rm$elm_slice_show$SliceShow$Content$hide(
		A3(
			author$project$Formatting$position,
	...
	[
		...
		_List_fromArray(
			[
				...
				author$project$Formatting$title('デモの時間！'))
			]))
	]);
	...
	[
		...
		_List_fromArray(
			[
				...
				author$project$Formatting$color,
				'#555555',
				author$project$Formatting$title('サイコロを振るゲーム')),
	...
	[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$Formatting$title('エルムで作ったゲーム')
					]))
			])),
		author$project$Formatting$spacer(50),
		author$project$Formatting$row(
...
var author$project$Main$intro = _List_fromArray(
	[
		...
		620,
		20,
		author$project$Formatting$title('エルムで物理法則と戦う')),
		A3(
		author$project$Formatting$position,
		620,
		633,
		...
		author$project$Formatting$bullets(
			_List_fromArray(
				[
					...
					A2(author$project$Formatting$bulletLink, 'ゲーム', 'https://unsoundscapes.itch.io'),
...
var author$project$Main$main = w0rm$elm_slice_show$SliceShow$show(
	w0rm$elm_slice_show$SliceShow$init(
		A2(
			...
			_List_fromArray(
				[author$project$Main$intro, author$project$Main$about, author$project$Main$games, author$project$Main$dice, author$project$Main$api, author$project$Main$debug, author$project$Main$demo, author$project$Main$links]))));
