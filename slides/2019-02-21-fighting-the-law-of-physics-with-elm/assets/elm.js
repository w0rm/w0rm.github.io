...
var author$project$Main$elmBerlin = _List_fromArray(
	[
		author$project$Formatting$col(
		_List_fromArray(
			[
				author$project$Formatting$spacer(150),
				A3(author$project$Formatting$image, 300, 300, 'assets/elm-berlin.svg'),
				A2(
				author$project$Formatting$color,
				'#5a6378',
				author$project$Formatting$title('\u00a0\u00a0\u00a0\u00a0Elm Berlin'))
			]))
	]);
...
var author$project$Main$future = _List_fromArray(
	[
		...
		100,
		50,
		author$project$Formatting$title('The Future of elm-physics')),
		A3(
		author$project$Formatting$position,
		100,
		150,
		author$project$Formatting$bullets(
			_List_fromArray(
				[
					...
					author$project$Formatting$bullet('Improve engine performance'),
					author$project$Formatting$bullet('Allow interaction with bodies'),
	...
	[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$Formatting$title('Games Created with Elm')
					]))
			])),
		author$project$Formatting$spacer(50),
		author$project$Formatting$row(
...
var author$project$Main$howItWorks = _List_fromArray(
	[
		...
		100,
		50,
		author$project$Formatting$title('How elm-phyics Works')),
		A3(
		author$project$Formatting$position,
		100,
		150,
		author$project$Formatting$bullets(
			_List_fromArray(
				[
					author$project$Formatting$bullet('Find pairs of bodies that can collide'),
					author$project$Formatting$bullet('Find collision points between bodies'),
					author$project$Formatting$bullet('Calculate updated velocities'),
					author$project$Formatting$bullet('Update positions and rotations')
				])))
	]);
...
var author$project$Main$main = w0rm$elm_slice_show$SliceShow$show(
	w0rm$elm_slice_show$SliceShow$init(
		A2(
			...
			_List_fromArray(
				[author$project$Main$intro, author$project$Main$games, author$project$Main$dice, author$project$Main$api, author$project$Main$howItWorks, author$project$Main$demo, author$project$Main$future, author$project$Main$elmBerlin]))));
