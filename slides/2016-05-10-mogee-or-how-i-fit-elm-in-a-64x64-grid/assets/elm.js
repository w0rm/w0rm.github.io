...
Elm.Mogee = Elm.Mogee || {};
Elm.Mogee.make = function (_elm) {
   "use strict";
   _elm.Mogee = _elm.Mogee || {};
   if (_elm.Mogee.values) return _elm.Mogee.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   var initial = _U.list([0,1,2,1]);
   var view = F2(function (_p1,frames) {
      var frame = A2($Maybe.withDefault,0,$List.head(frames));
      return A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: "69px"}
                                              ,{ctor: "_Tuple2",_0: "height",_1: "100px"}
                                              ,{ctor: "_Tuple2",_0: "background-image",_1: "url(assets/mogee.png)"}
                                              ,{ctor: "_Tuple2",_0: "background-size",_1: "210px 100px"}
                                              ,{ctor: "_Tuple2"
                                               ,_0: "background-position"
                                               ,_1: A2($Basics._op["++"],$Basics.toString((0 - frame) * 70),"px 0")}]))]),
      _U.list([]));
   });
   var update = F2(function (_p2,model) {    return {ctor: "_Tuple2",_0: animate(model),_1: $Effects.none};});
   var input = $Time.fps(2);
   return _elm.Mogee.values = {_op: _op,initial: initial,update: update,input: input,view: view};
};
Elm.Model = Elm.Model || {};
Elm.Model.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Mogee = Elm.Mogee.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var MogeeModel = function (a) {    return {ctor: "MogeeModel",_0: a};};
   var mogee = MogeeModel($Mogee.initial);
   return _elm.Model.values = {_op: _op,mogee: mogee,MogeeModel: MogeeModel};
};
...
Elm.Formatting.make = function (_elm) {
   ...
   var arrow = F2(function (_p1,_p0) {
      ...
      var _p4 = _p3._0;
      var border = 20;
      var x = A2($Basics.min,_p6,_p4) - border;
      var y = A2($Basics.min,_p7,_p5) - border;
      var wid = A2($Basics.max,_p6,_p4) - x + border;
      var hei = A2($Basics.max,_p7,_p5) - y + border;
      return $SliceShow$Content.item(A2($Svg.svg,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "position",_1: "absolute"}
                                              ,{ctor: "_Tuple2",_0: "left",_1: A2($Basics._op["++"],$Basics.toString(x),"px")}
                                              ,{ctor: "_Tuple2",_0: "top",_1: A2($Basics._op["++"],$Basics.toString(y),"px")}
                                              ,{ctor: "_Tuple2",_0: "width",_1: A2($Basics._op["++"],$Basics.toString(wid),"px")}
                                              ,{ctor: "_Tuple2",_0: "height",_1: A2($Basics._op["++"],$Basics.toString(hei),"px")}]))
              ,$Svg$Attributes.viewBox(A2($Basics._op["++"],
              "0 0 ",
              A2($Basics._op["++"],$Basics.toString(wid),A2($Basics._op["++"]," ",A2($Basics._op["++"],$Basics.toString(hei),"")))))]),
      _U.list([A2($Svg.line,
      _U.list([$Svg$Attributes.x1($Basics.toString(_p6 - x))
              ,$Svg$Attributes.x2($Basics.toString(_p4 - x))
              ,$Svg$Attributes.y1($Basics.toString(_p7 - y))
              ,$Svg$Attributes.y2($Basics.toString(_p5 - y))
              ,$Svg$Attributes.stroke("#808e69")
              ,$Svg$Attributes.strokeWidth("5")
              ,$Svg$Attributes.markerEnd("url(#arrow)")]),
      _U.list([]))])));
   });
   var node = F2(function (_p8,str) {
      var _p9 = _p8;
      return $SliceShow$Content.item(A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "position",_1: "absolute"}
                                              ,{ctor: "_Tuple2",_0: "left",_1: A2($Basics._op["++"],$Basics.toString(_p9._0),"px")}
                                              ,{ctor: "_Tuple2",_0: "top",_1: A2($Basics._op["++"],$Basics.toString(_p9._1),"px")}
                                              ,{ctor: "_Tuple2",_0: "font-family",_1: "FiraCode"}
                                              ,{ctor: "_Tuple2",_0: "font-size",_1: "20px"}]))]),
      _U.list([$Html.text(str)])));
   });
   var position = function (_p10) {
      var _p11 = _p10;
      return $SliceShow$Content.container($Html.div(_U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "position",_1: "absolute"}
                                                                                            ,{ctor: "_Tuple2"
                                                                                             ,_0: "left"
                                                                                             ,_1: A2($Basics._op["++"],$Basics.toString(_p11._0),"px")}
                                                                                            ,{ctor: "_Tuple2"
                                                                                             ,_0: "top"
                                                                                             ,_1: A2($Basics._op["++"],$Basics.toString(_p11._1),"px")}]))])));
   };
   ...
   var richtext = function (_p12) {    return $SliceShow$Content.item($Markdown.toHtml(_p12));};
   var image = F2(function (_p13,url) {
      var _p14 = _p13;
      return $SliceShow$Content.item(A2($Html.img,
      _U.list([$Html$Attributes.src(url)
              ,$Html$Attributes.width(_p14._0)
              ,$Html$Attributes.height(_p14._1)
   ...
   var slideStyles = _U.list([{ctor: "_Tuple2",_0: "padding",_1: slidePadding}
                             ,{ctor: "_Tuple2",_0: "height",_1: "640px"}
                             ,{ctor: "_Tuple2",_0: "box-sizing",_1: "border-box"}
                             ,{ctor: "_Tuple2",_0: "color",_1: "#eee"}
                             ,{ctor: "_Tuple2",_0: "position",_1: "relative"}]);
   var padded = $SliceShow$Content.container($Html.div(_U.list([$Html$Attributes.style(A2($List._op["::"],
   {ctor: "_Tuple2",_0: "background-color",_1: "#161116"},
   slideStyles))])));
   var background = function (url) {
      return $SliceShow$Content.container($Html.div(_U.list([$Html$Attributes.style(A2($Basics._op["++"],
      slideStyles,
      _U.list([{ctor: "_Tuple2",_0: "background-image",_1: A2($Basics._op["++"],"url(",A2($Basics._op["++"],url,")"))}
              ,{ctor: "_Tuple2",_0: "background-size",_1: "cover"}
              ,{ctor: "_Tuple2",_0: "background-color",_1: "#000"}])))])));
   };
   var shout = function (str) {
      return $SliceShow$Content.item(A2($Html.div,
      _U.list([$Html$Attributes.style(A2($Basics._op["++"],
      slideStyles,
      _U.list([{ctor: "_Tuple2",_0: "background-color",_1: "#161116"}
              ,{ctor: "_Tuple2",_0: "font-size",_1: "72px"}
              ,{ctor: "_Tuple2",_0: "line-height",_1: "1.2"}
...
Elm.Slides.make = function (_elm) {
   ...
   $SliceShow$Slide = Elm.SliceShow.Slide.make(_elm);
   var _op = {};
   var questions = _U.list([$Formatting.title("Questions?")
                           ,A2($Formatting.position,{ctor: "_Tuple2",_0: 850,_1: 440},_U.list([$SliceShow$Content.custom($Model.mogee)]))]);
   var futurePlans = _U.list([$Formatting.title("Future Plans")
                             ,$Formatting.bullets(_U.list([$Formatting.bullet("Improve the graphics")
                                                          ,$Formatting.bullet("Add 8bit sound effects")
                                                          ,$Formatting.bullet("Migrate to Elm 0.17")]))]);
   var viewDiscoveries = _U.list([$Formatting.title("View: Discoveries")
                                 ,$Formatting.bullets(_U.list([$SliceShow$Content.hide($Formatting.bullet("WebGL is not made for pixel art"))
                                                              ,$SliceShow$Content.hide($Formatting.bullet("WebGL is not made for pixel art"))
                                                              ,$SliceShow$Content.hide($Formatting.bullet("List.foldl is good to convert game objects into renderables"))]))]);
   var sprite = _U.list([$Formatting.title("View: Sprite")
                        ,$Formatting.bullets(_U.list([$Formatting.bullet("64×64px")
                                                     ,$Formatting.bullet("transparent png")
                                                     ,$Formatting.bullet("base64 data uri")]))
                        ,A2($Formatting.position,
                        {ctor: "_Tuple2",_0: 480,_1: 100},
                        _U.list([A2($Formatting.image,{ctor: "_Tuple2",_0: 448,_1: 448},"assets/texture.png")]))]);
   var discoveries = _U.list([$Formatting.title("Update: Discoveries")
                             ,$Formatting.bullets(_U.list([$SliceShow$Content.hide($Formatting.bullet("List.foldl is a good way to update the list of game objects"))
                                                          ,$SliceShow$Content.hide($Formatting.bullet("List.foldl is helpful when one object has to interact with multiple objects"))
                                                          ,$SliceShow$Content.hide($Formatting.bullet("The order of execution matters, because objects interact with old copies"))]))
                             ,$SliceShow$Content.hide($Formatting.richtext("Check the article [\"Immutability is not enough\"](https://codewords.recurse.com/issues/six/immutability-is-not-enough) by Patrick Dubroy"))]);
   var view = _U.list([$Formatting.title("View: WebGL")
                      ,A2($Formatting.scale,
                      0.9,
   ...
   var update = _U.list([$Formatting.title("Update")
                        ,A2($Formatting.scale,
                        0.8,
                        _U.list([A2($Formatting.code,
                        "elm",
   ...
   var model = _U.list([$Formatting.title("Model")
                       ,A2($Formatting.split,
                       _U.list([A2($Formatting.code,
                       "elm",
                       "type alias Model =\n  { objects : List Object\n  , direction : Direction\n  , seed : Random.Seed\n  , state : GameState\n  , lives : Int\n  , score : Int\n  , currentScore : Int\n  , screens : Int\n  }")]),
                       _U.list([$SliceShow$Content.hide(A2($Formatting.code,
                               "elm",
                               "type alias Object =\n  { number : Int\n  , category : Category\n  , velocity : (Float, Float)\n  , size : (Float, Float)\n  , position : (Float, Float)\n  }"))
                               ,$SliceShow$Content.hide(A2($Formatting.code,
                               "elm",
                               "type Category\n  = WallCategory\n  | MogeeCategory Mogee\n  | ScreenCategory Direction"))]))]);
   var signalGraph = _U.list([$Formatting.title("Signal Graph")
                             ,$SliceShow$Content.hide($Formatting.group(_U.list([A2($Formatting.node,{ctor: "_Tuple2",_0: 450,_1: 110},"fps60")
                                                                                ,A2($Formatting.node,{ctor: "_Tuple2",_0: 550,_1: 110},"Keyboard.arrows")
                                                                                ,A2($Formatting.node,{ctor: "_Tuple2",_0: 780,_1: 110},"Keyboard.enter")])))
                             ,$SliceShow$Content.hide($Formatting.group(_U.list([A2($Formatting.arrow,
                                                                                {ctor: "_Tuple2",_0: 480,_1: 150},
                                                                                {ctor: "_Tuple2",_0: 550,_1: 200})
                                                                                ,A2($Formatting.arrow,
                                                                                {ctor: "_Tuple2",_0: 630,_1: 150},
                                                                                {ctor: "_Tuple2",_0: 630,_1: 200})
                                                                                ,A2($Formatting.arrow,
                                                                                {ctor: "_Tuple2",_0: 850,_1: 150},
                                                                                {ctor: "_Tuple2",_0: 750,_1: 200})
                                                                                ,A2($Formatting.node,{ctor: "_Tuple2",_0: 550,_1: 220},"Signal.map3 (,,)")])))
                             ,$SliceShow$Content.hide($Formatting.group(_U.list([A2($Formatting.arrow,
                                                                                {ctor: "_Tuple2",_0: 630,_1: 270},
                                                                                {ctor: "_Tuple2",_0: 630,_1: 300})
                                                                                ,A2($Formatting.node,
                                                                                {ctor: "_Tuple2",_0: 520,_1: 320},
                                                                                "Signal.sampleOn fps60")])))
                             ,$SliceShow$Content.hide($Formatting.group(_U.list([A2($Formatting.arrow,
                                                                                {ctor: "_Tuple2",_0: 630,_1: 370},
                                                                                {ctor: "_Tuple2",_0: 630,_1: 400})
                                                                                ,A2($Formatting.node,
                                                                                {ctor: "_Tuple2",_0: 470,_1: 420},
                                                                                "Signal.foldp Model.update Model.model")])))
                             ,$SliceShow$Content.hide($Formatting.group(_U.list([A2($Formatting.arrow,
                                                                                {ctor: "_Tuple2",_0: 630,_1: 470},
                                                                                {ctor: "_Tuple2",_0: 500,_1: 500})
                                                                                ,A2($Formatting.node,{ctor: "_Tuple2",_0: 100,_1: 320},"Window.dimensions")
                                                                                ,A2($Formatting.arrow,
                                                                                {ctor: "_Tuple2",_0: 180,_1: 370},
                                                                                {ctor: "_Tuple2",_0: 350,_1: 500})
                                                                                ,A2($Formatting.node,{ctor: "_Tuple2",_0: 330,_1: 320},"texture")
                                                                                ,A2($Formatting.arrow,
                                                                                {ctor: "_Tuple2",_0: 370,_1: 370},
                                                                                {ctor: "_Tuple2",_0: 420,_1: 500})
                                                                                ,A2($Formatting.node,
                                                                                {ctor: "_Tuple2",_0: 340,_1: 520},
                                                                                "Signal.map3 view")])))]);
   var game = _U.list([A2($Formatting.position,
                      {ctor: "_Tuple2",_0: 224,_1: 32},
                      _U.list([A3($Formatting.demo,"576px","576px","http://unsoundscapes.com/elm-mogee.html")]))
                      ,A2($Formatting.position,{ctor: "_Tuple2",_0: 60,_1: 550},_U.list([$Formatting.richtext("[prev slide](#3)")]))
                      ,A2($Formatting.position,{ctor: "_Tuple2",_0: 860,_1: 550},_U.list([$Formatting.richtext("[next slide](#5)")]))]);
   var goals = _U.list([$Formatting.title("Goals")
                       ,$Formatting.bullets(_U.list([$Formatting.bullet("Code the game engine from scratch")
                                                    ,$Formatting.bullet("Use Signals instead of StartApp")
                                                    ,$Formatting.bullet("Submit a playable MVP in 3 days")]))]);
   var lowresjam = _U.list([$Formatting.title("#LOWRESJAM")
                           ,$Formatting.richtext("Make a game with a resolution of 64×64 pixels using whatever programming platform you\'d like, with as few or as many colors as you\'d like, with any fidelity of sound you\'d like, and 2D or 3D graphics!")
                           ,$Formatting.richtext("[itch.io/jam/lowrezjam2016](https://itch.io/jam/lowrezjam2016)")]);
   var intro = _U.list([$Formatting.title("Mogee or How I Fit Elm in a 64×64 Grid")
                       ,A2($Formatting.position,{ctor: "_Tuple2",_0: 850,_1: 440},_U.list([$SliceShow$Content.custom($Model.mogee)]))
                       ,$Formatting.richtext("Andrey Kuzmin [@unsoundscapes](https://twitter.com/unsoundscapes)")
                       ,$Formatting.spacing(260)
   ...
   _U.list([_U.list([$Formatting.padded(intro)])
           ,_U.list([$Formatting.padded(lowresjam)])
           ,_U.list([$Formatting.padded(goals)])
           ,_U.list([A2($Formatting.background,"",game)])
           ,_U.list([$Formatting.padded(signalGraph)])
           ,_U.list([$Formatting.shout("Using signals instead of StartApp simplifies the game")])
           ,_U.list([$Formatting.padded(model)])
           ,_U.list([$Formatting.padded(update)])
           ,_U.list([$Formatting.padded(discoveries)])
           ,_U.list([$Formatting.padded(view)])
           ,_U.list([$Formatting.padded(sprite)])
           ,_U.list([$Formatting.padded(viewDiscoveries)])
           ,_U.list([$Formatting.padded(futurePlans)])
           ,_U.list([$Formatting.padded(questions)])]));
...
Elm.Main.make = function (_elm) {
   ...
   var MogeeAction = function (a) {    return {ctor: "MogeeAction",_0: a};};
   var inputs = _U.list([A2($Signal.map,MogeeAction,$Mogee.input)]);
   var update = F2(function (action,model) {
      var _p0 = {ctor: "_Tuple2",_0: action,_1: model};
      var _p1 = A2($Mogee.update,_p0._0._0,_p0._1._0);
      var newModel = _p1._0;
      var newEffect = _p1._1;
      return {ctor: "_Tuple2",_0: $Model.MogeeModel(newModel),_1: A2($Effects.map,MogeeAction,newEffect)};
   });
   var view = F2(function (action,model) {    var _p2 = model;return A2($Mogee.view,A2($Signal.forwardTo,action,MogeeAction),_p2._0);});
   var sliceShow = $SliceShow.show(A2($SliceShow.setInputs,
   inputs,
   A2($SliceShow.setView,
   view,
   ...
   return _elm.Main.values = {_op: _op,MogeeAction: MogeeAction,inputs: inputs,update: update,view: view,sliceShow: sliceShow,main: main};
};
