...
import Color
import Common.Jeep as Jeep exposing (Jeep, wheels)
...
import Illuminance exposing (inLux)
import Json.Decode
import Length exposing (Meters, points)
import Mass
...
renderText : String -> Msg -> Msg -> Html Msg
renderText label msg1 msg2 =
    button
...
view { world, jeep, dimensions } =
    div
        ...
        , div
            ...
            [ div [] [ renderText "W" (KeyDown (Speed 1)) (KeyUp (Speed 1)) ]
            , div []
                [ renderText "A" (KeyDown (Steer -1)) (KeyUp (Steer -1))
                , renderText "S" (KeyDown (Speed -1)) (KeyUp (Speed -1))
                , renderText "D" (KeyDown (Steer 1)) (KeyUp (Steer 1))
                ]
            ]
        ]
...
camera =
    Camera3d.perspective
        { viewpoint =
            Viewpoint3d.lookAt
                { eyePoint = Point3d.meters -35 35 25
