module Custom.DuckYUp exposing
    ( Model
    , Msg
    , Options
    , initial
...
type alias Model =
    ...
    , duck : Maybe (Scene3d.Mesh.Textured ObjCoordinates)
    , firstTick : Bool
...
type Msg
    = Tick Float
    | LoadedDuck (Result Http.Error (Scene3d.Mesh.Textured ObjCoordinates))
    | LoadedTexture (Result WebGL.Texture.Error (Texture Color))


duckDecoder : Decoder (Scene3d.Mesh.Textured ObjCoordinates)
duckDecoder =
...
camera : Camera3d Meters ObjCoordinates
camera =
